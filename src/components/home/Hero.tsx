...
export const HomeHero: React.FC = () => {
  return (
    <div className="h-[37rem] w-full bg-hero-pattern bg-cover bg-center bg-no-repeat">
      <div className="container relative flex size-full justify-end">
        <div className="relative">
          ...
          <div className="absolute top-14 z-0 ml-[4rem] size-full bg-shape bg-no-repeat"></div>
        </div>
      </div>
    </div>
  );
